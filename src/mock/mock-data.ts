...
export const mockTournaments: Tournament[] = [
  { id: 'tour-01', name: '裂隙冠军夜', game: GameTitle.LOL, format: TournamentFormat.SINGLE_ELIM, teamSize: 5, maxTeams: 16, startDate: '2026-06-18', endDate: '2026-06-21', prize: '冠军皮肤基金 20000 元', status: TournamentStatus.IN_PROGRESS, rules: 'BO3 单败淘汰，决赛 BO5。', minTeamSize: 5, minRank: PlayerRank.DIAMOND, teams: ['team-03', 'team-06'], bracket: { rounds: [{ name: '半决赛', matches: [{ id: 'm-03', teamA: 'team-03', teamB: 'team-06', scoreA: 2, scoreB: 1 }] }] } },
  { id: 'tour-02', name: 'Red Spike Open', game: GameTitle.VALORANT, format: TournamentFormat.DOUBLE_ELIM, teamSize: 5, maxTeams: 12, startDate: '2026-06-20', endDate: '2026-06-23', prize: '外设套装与训练房时长', status: TournamentStatus.REGISTRATION, rules: '双败淘汰，地图池随机。', minTeamSize: 3, minRank: PlayerRank.GOLD, teams: ['team-02', 'team-09'], bracket: { rounds: [{ name: '胜者组 R1', matches: [{ id: 'm-02', teamA: 'team-02', teamB: 'team-09', scoreA: 0, scoreB: 0 }] }] } },
